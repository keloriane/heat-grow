...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "animationAbout": () => /* binding */ animationAbout
/* harmony export */ });
...
gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin((gsap_dist_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2___default()));
...
var animationAbout = {
  ...
  mainArticle: function mainArticle() {
    var tl = gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline();
    tl.to('.nav-main', {
      opacity: 1
    }).to('.about-wrapper', {
      opacity: 1
    }).from('.about-title', fadeInUp).from('.about-img-wrapper', fadeIn).from('.about-img', deScale).from('.about-main-text p', fadeInUpStagger, "-=3").to('.about-wrapper', {
      backgroundColor: 'black',
      duration: 0.3
    }).to('.about-title', {
      color: 'white',
      duration: 0.3
    }).to('.about-main-text p', {
      color: 'white',
      duration: 0.3
    });
  },
  reinitialization: function reinitialization() {
    gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set('.about-wrapper', {
      opacity: 0
    });
  ...
  textScroll: function textScroll() {
    return gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.text-scroll', {
      scrollTrigger: {
        markers: true,
        trigger: ".text-scroll",
        start: '-=300',
...
/* harmony import */ var _header_gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./header.gsap */ "./src/js/gsap/header.gsap.js");
/* harmony import */ var _home_gsap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./home.gsap */ "./src/js/gsap/home.gsap.js");
...
_barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
  ...
  views: [{
    ...
    afterEnter: function afterEnter(data) {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.delay)(_about_gsap__WEBPACK_IMPORTED_MODULE_2__.animationAbout._enter, 1500);
    },
    ...
    namespace: 'home',
    afterEnter: function afterEnter(data) {
      _header_gsap__WEBPACK_IMPORTED_MODULE_3__.headerAnimation._enter();
    },
    beforeEnter: function beforeEnter(data) {}
  }, {
    namespace: 'service',
    beforeEnter: function beforeEnter(data) {
      gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_6___default().from('#service', {
        duration: 1,
        rotate: 360
      });
      console.log("yo");
...
var titleLines = document.querySelectorAll(".title-anim");
var block = document.querySelectorAll('.block-anim');
var headerAnimation = {
  _enter: function _enter() {
    console.log("test");
  ...
  header: function header() {
    /*let tl = gsap.timeline()
      ...
      */
    return gsap_dist_gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.from('.title-anim', {
      duration: 1,
      opacity: 0
    });
  },
