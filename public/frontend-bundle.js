...
_barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
  ...
  views: [{
    ...
    afterEnter: function afterEnter(data) {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.delay)(_about_gsap__WEBPACK_IMPORTED_MODULE_2__.animationAbout._enter, 1500);
    },
    beforeEnter: function beforeEnter(data) {
      _about_gsap__WEBPACK_IMPORTED_MODULE_2__.animationAbout._beforeEnter();
    }
  }, {
    namespace: 'home',
    afterEnter: function afterEnter(data) {
      (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.delay)(_home_gsap__WEBPACK_IMPORTED_MODULE_3__.animationHome._enter, 1500);
    },
    beforeEnter: function beforeEnter(data) {
      _home_gsap__WEBPACK_IMPORTED_MODULE_3__.animationHome._beforeEnter();
    }
  }]
});
